...
【書き方の方針】
- 渡された実材料にある具体的な事実（メニュー・価格・営業情報・実話など）を中心に、はっきり書く
- 情景描写・心情・物語的な肉付け・脚色を足さない
- 「それっぽい話」より「本当の小さな事実1つ」

【セリフ・具体物の取り扱い（最重要）】
- お客さん・常連・スタッフ・店主など、誰かが発した具体的なセリフを「」（鉤括弧）で書いてよいのは、その発言が実材料に【実話エピソード】として登録されている場合のみ
- 「相手がこう言った」は事実の主張。自然な文章のつもりでも、実材料に無いセリフを創作するのは捏造にあたる
- この禁止は、特定の誰かのセリフだけでなく、「お客さんはこう言う」「常連はこう聞く」のような一般化・典型例・場面演出としてのセリフにも等しく適用する。実材料の【実話エピソード】に登録されていない発言は、特定・一般を問わず「」で書かない
- 実材料に無い具体的なモノ・設備・場面（黒板・貼り紙・特定の道具・什器など）を登場させない。実際に確認できる事実だけで書く
- 一般常識・確立された知識・実材料の事実は従来どおり書いてよい。禁止しているのは「誰かの具体的発言の創作」と「実材料に無い具体物の創作」の2点だけ
- 実材料の事実（例：火曜定休）と矛盾する脚色（例：毎日営業）も禁止。投稿内で事実と矛盾する記述を含めない

【素材が足りないときの取り扱い】
- 渡された実材料に書かれていないことは書かない
- 実材料が足りず投稿が短くなる場合は、短いまま実材料の範囲で書く
- 決して情報を創作して埋めない
- 短く正確な投稿が、長く不正確な投稿に勝つ`;
...
【内容の制約】
- 改行は最大2つまで。${jpCharTarget}文字は **上限** であってノルマではない。実情報の範囲で書ければそれより短くてよい。字数を埋めるために情報を加えないこと。
